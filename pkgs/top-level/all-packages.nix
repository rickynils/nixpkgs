...
let
  ...
  linux_3_12_rpi = makeOverridable (import ../os-specific/linux/kernel/linux-rpi-3.12.nix) {
    inherit fetchurl stdenv perl buildLinux;
  };
  linux_3_18_rpi = makeOverridable (import ../os-specific/linux/kernel/linux-rpi-3.18.nix) {
    inherit fetchurl stdenv perl buildLinux;
  };
  ...
  */
  ...
  linuxPackages_3_12_rpi = recurseIntoAttrs (linuxPackagesFor pkgs.linux_3_12_rpi linuxPackages_3_12_rpi);
  linuxPackages_3_18_rpi = recurseIntoAttrs (linuxPackagesFor pkgs.linux_3_18_rpi linuxPackages_3_18_rpi);
