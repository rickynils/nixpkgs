...
let
  ...
  linux_3_16_rpi = makeOverridable (import ../os-specific/linux/kernel/linux-rpi-3.16.nix) {
    inherit fetchurl stdenv perl buildLinux;
  };
  ...
  linuxPackages_3_16_rpi = recurseIntoAttrs (linuxPackagesFor pkgs.linux_3_16_rpi linuxPackages_3_16_rpi);
