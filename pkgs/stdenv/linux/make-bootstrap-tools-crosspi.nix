...
let
  ...
  coreutilsMinimal_ = pkgs.coreutils.override (args: {
    aclSupport = false;
  });

  curlMinimal_ = pkgs.curl.override {
    zlibSupport = false;
    sslSupport = false;
    scpSupport = false;
  };

  busyboxMinimal_ = pkgs.busybox.override {
    useUclibc = true;
    enableStatic = true;
    enableMinimal = true;
    extraConfig = ''
  ...
  coreutilsMinimal = coreutilsMinimal_.crossDrv;
  curlMinimal = curlMinimal_.crossDrv;
  busyboxMinimal = busyboxMinimal_.crossDrv;
